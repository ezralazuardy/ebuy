        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              ...
              and payment details, when you sign up for our services or make a
              purchase. We also collect usage data, such as the pages you visit
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              ...
              services, process payments, and communicate with you. We may also
              use your data for analytics and marketing purposes, but we will
              always obtain your consent before doing so.
            </p>
          </div>
          <div className="space-y-2">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              ...
              processors and web hosting providers. We will never sell or rent
              your personal information to any third party without your explicit
              consent.
            </p>
          </div>
          <div className="space-y-2">
