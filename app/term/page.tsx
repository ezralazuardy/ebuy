        ...
        <div className="mx-auto max-w-3xl space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-500 dark:text-gray-400">
              Welcome to {process.env.NEXT_PUBLIC_APP_NAME} By using our
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                ...
                other {process.env.NEXT_PUBLIC_APP_NAME} services, you agree to
                be bound by these terms of service, our privacy policy, and any
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                ...
                are owned by {process.env.NEXT_PUBLIC_APP_NAME} and are
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                In no event shall {process.env.NEXT_PUBLIC_APP_NAME} be liable
